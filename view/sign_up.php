...
<body>
  ...
  <div class="container h-100">
    ...
    <form action="/AGLIC/gestionnaire.php" method="post" class="mx-1 mx-md-4">
    ...
    <div class="d-flex flex-row align-items-center mb-4">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          <input type="submit" name="submit" value="sign-up" class="btn btn-primary btn-lg" onclick="validatePassword()">  
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/6-col/img%20(122).jpg"
